var Login = function () {
    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch(["../static/newTheme/assets/pages/img/login/bg1.jpg", "../static/newTheme/assets/pages/img/login/bg2.jpg", "../static/newTheme/assets/pages/img/login/bg3.jpg"], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
